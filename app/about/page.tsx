            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-lg md:text-xl font-light leading-relaxed text-slate-300">
                ...
                <p>
                  ...
                  development and building from scratch. Today, I design
                  scalable full-stack applications with real-world architecture
                  — not tutorials, not clones, but production-ready systems.
                </p>
                <p>

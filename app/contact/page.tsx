...
export default function Contact() {
  ...
  return (
    <div className="flex flex-col justify-center relative z-10 pt-32 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
            ...
            <form className="flex flex-col gap-8 w-full max-w-3xl mt-8">
              {["Name", "Email", "Project Type"].map((label) => (
                <div key={label} className="relative group">
                  <label
                    className="absolute -top-3 left-4 bg-black px-2 text-xs font-mono text-primary uppercase tracking-widest border border-white/20"
          ...
          <div className="lg:col-span-4 flex flex-col justify-end lg:h-full pb-8 lg:pb-0">
            <div className="flex flex-col gap-2 lg:gap-4 items-start lg:items-end">
              <p className="text-white/40 font-mono text-sm mb-4 lg:mb-8 text-right uppercase tracking-widest">
                Connect Elsewhere
              </p>
              {socials.map((social) => (
                <Link
              ...
              <div className="mt-12 w-full aspect-video border border-white/20 relative group overflow-hidden grayscale hover:grayscale-0 transition-all duration-500 rounded-sm">
                ...
                />
                <div className="absolute bottom-0 left-0 bg-primary/90 text-white px-3 py-1 text-xs font-mono uppercase tracking-widest">
                  {" "}
